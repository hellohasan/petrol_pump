                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select name="payment_type" id="payment_type" required class="form-control select2 font-weight-bold">
                                            ...
                                            @role('Super Admin')
                                            <option value="0" class="font-weight-bold">Deposit Amount</option>
                                            <option value="1" class="font-weight-bold">Withdraw Amount</option>
                                            @endrole
                                            <option value="2" class="font-weight-bold">Expense Amount</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
