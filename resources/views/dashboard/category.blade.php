            ...
            <div class="modal-content" >
                ...
                <div class="modal-body">
                    <form id="frmProducts" name="frmProducts" class="form-horizontal" novalidate="">
                        ...
                        <div class="form-group row">
                            <label for="inputName" class="col-sm-3 text-right control-label font-weight-bold uppercase">Category Name : </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control has-error font-weight-bold " id="name" name="name" placeholder="Category Name" value="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputName" class="col-sm-3 text-right control-label font-weight-bold uppercase">Measurement Unit : </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control has-error font-weight-bold " id="unit" name="unit" placeholder="Measurement  Unit" value="">
                            </div>
                        </div>
                        <div class="form-group row">
        ...
        $("#btn-save").click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    console.log(data);
                    var product = '<tr id="product' + data.id + '"><td>' + data.id + '</td><td>' + data.company + '</td><td>' + data.name + '</td><td>' + data.unit + '</td><td>'+ '<label class="label label-'+(data.status == 1 ? 'success' :'warning')+ '">' +(data.status == 1 ? 'Active' :'Deactive') +'</label></td>';
