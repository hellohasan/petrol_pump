                            ...
                            <div class="row">
                                            ...
                                            <div class="card-body">
                                                <div class="media d-flex">
                                                    <div class="media-body white text-left">
                                                        <h3>{{ $basic->symbol }}{{ \Illuminate\Support\Facades\Auth::user()->balance }}</h3>
                                ...
                                <div class="col-xl-3 col-lg-6 col-12">
                                    <div class="card bg-gradient-directional-success">
                                        <div class="card-content">
                                            <div class="card-body">
                                                <a href="{{ route('fuel.sell') }}">
                                                    <div class="media d-flex">
                                                        <div class="media-body white text-left">
                                                            <h3>Sell Fuel</h3>
                                                            <span class="font-weight-bold text-uppercase">Sell ongoing</span>
                                                        </div>
                                                        <div class="align-self-center">
                                                            <i class="ft ft-shopping-cart white font-large-2 float-right"></i>
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
                                ...
                                <div class="col-xl-3 col-lg-6 col-12">
                                    <div class="card bg-gradient-directional-warning">
                                        <div class="card-content">
                                            <div class="card-body">
                                                <a href="{{ route('fuel.sell.history') }}">
                                                    <div class="media d-flex">
                                                        <div class="media-body white text-left">
                                                            <h3>Sell History</h3>
                                                            <span class="font-weight-bold text-uppercase">History ongoing</span>
                                                        </div>
                                                        <div class="align-self-center">
                                                            <i class="ft ft-repeat white font-large-2 float-right"></i>
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
                                                ...
                                                <a href="{{ route('transaction-log') }}">
                                                    <div class="media d-flex">
                                                        <div class="media-body white text-left">
                                                            ...
                                                            <span class="font-weight-bold text-uppercase">see transaction</span>
                                                        </div>
                                                        <div class="align-self-center">
                                            ...
                                            <div class="card-body">
                                                <div class="media d-flex">
                                                    <div class="media-body white text-left">
                                                        ...
                                                        <span class="font-weight-bold text-uppercase">Withdraw</span>
                                                    </div>
                                                    <div class="align-self-center">
                                    ...
                                    <div class="card bg-gradient-directional-purple">
                                        <div class="card-content">
                                            <div class="card-body">
                                                <div class="media d-flex">
                                                    <div class="media-body white text-left">
                                                        <h3>{{ $basic->symbol }}{{ $discount }}</h3>
                                                        <span class="font-weight-bold text-uppercase">Discount - Less</span>
                                                    </div>
                                                    <div class="align-self-center">
                                                        <i class="ft ft-upload white font-large-2 float-right"></i>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
