                                ...
                                <table class="table table-striped table-bordered table-hover zero-configuration">
                                    ...
                                    @foreach($history as $k => $p)
                                        <tr class="{{ $p->deleted_at != null ? 'bg-warning white' : '' }}">
                                            ...
                                            <td>{{ $basic->symbol }}{{ $p->post_due }}</td>
                                            <td>
                                                <a href="{{ route('print-invoice',$p->ref_custom) }}" class="btn btn-primary btn-sm  font-weight-bold text-uppercase" title="View"><i class="fa fa-file-text"></i> invoice</a>
