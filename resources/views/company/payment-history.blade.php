                            ...
                            <table class="table table-striped table-bordered table-hover zero-configuration">
                                ...
                                @foreach($history as $k => $p)
                                    <tr class="">
                                        ...
                                        <td>
                                            @if($p->payment_type == 0)
                                                <div class="badge badge-warning font-weight-bold text-uppercase">Company Send</div>
                                            @else
                                                <div class="badge badge-success font-weight-bold text-uppercase">We Send</div>
                                            @endif
                                        </td>
