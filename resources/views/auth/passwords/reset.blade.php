...
<head>
    ...
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('storage/admin/css/style.css') }}">
    <!-- END Custom CSS-->
</head>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    @if($errors->any())
                                        ...
                                        @endforeach
                                    @endif
                                    <form class="form-horizontal form-simple" action="{{ route('password.request') }}" method="post" novalidate>
                                        {!! csrf_field() !!}
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="password" name="password" class="form-control form-control-lg input-lg" id="user-password" placeholder="New Password" required>
                                            <div class="form-control-position">
                                                <i class="fa fa-key"></i>
                                            </div>
                                        </fieldset>
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="password" name="password_confirmation" class="form-control form-control-lg input-lg" id="user-password-confirmation" placeholder="Confirm Password" required>
                                            <div class="form-control-position">
                                                <i class="fa fa-key"></i>
                                            </div>
                                        </fieldset>
