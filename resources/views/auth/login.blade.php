                        ...
                        <div class="card bg-gradient-x-success border-lighten-3 m-0 rounded">
                            <div class="card-header border-0">
                                <div class="card-title text-center">
                                    <div class="p-1">
                                        <img src="{{ asset('storage/images/logo.png') }}" alt="branding logo">
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form-horizontal form-simple" action="{{ route('login') }}" method="post" novalidate>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 col-12 text-center text-md-right"><a href="{{ route('password.request') }}" class="card-link white"><i class="fa fa-link"></i> Forgot Password?</a></div>
                                        </div>
