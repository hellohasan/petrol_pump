                ...
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            ...
                            {!! Form::model($product,['route'=>['product-update',$product->id],'method'=>'put','class'=>'form-horizontal','role'=>'form']) !!}
                                <div class="form-body">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group row">
                                                <label class="col-md-12"><strong style="text-transform: uppercase;">Product Buy Rate</strong></label>
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        <input name="buy_price" class="form-control bold" value="{{ $product->buy_price }}" placeholder="Product Buy Rate" required/>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group row">
                                                <label class="col-md-12"><strong style="text-transform: uppercase;">Product Sell Rate</strong></label>
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        <input name="sell_price" class="form-control bold" value="{{ $product->sell_price }}" placeholder="Product Sell Rate" required/>
                                                        <span class="input-group-addon"><strong>{{ $basic->currency }}</strong></span>
                                                    </div>
                                                </div>
                                            </div>
