                ...
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            ...
                            <form action="{{ route('product-new') }}" class="form-horizontal" method="post" role="form">
                                {!! csrf_field() !!}
                                <div class="form-body">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        <input name="buy_price" class="form-control bold" value="{{ old('buy_price') }}" placeholder="Product Buy Rate" required/>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        <input name="sell_price" class="form-control bold" value="{{ old('sell_price') }}" placeholder="Product Sell Rate" required/>
                                                        <span class="input-group-addon"><strong>{{ $basic->currency }}</strong></span>
                                                    </div>
                                                </div>
                                            </div>
