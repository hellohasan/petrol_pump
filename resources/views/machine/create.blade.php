                ...
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            ...
                            <form action="{{ route('machine.store') }}" class="form-horizontal" method="post" role="form">
                                {!! csrf_field() !!}
                                <div class="form-body">
                                    <div class="row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        <input name="name" class="form-control bold" value="{{ old('name') }}" placeholder="Machine Name" required/>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        <input name="code" class="form-control bold" value="{{ old('code') }}" placeholder="Machine Code" required/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        <input name="current_reading" class="form-control bold" value="{{ old('current_reading') }}" placeholder="Machine Current Reading" required/>
                                                        <span class="input-group-addon"><strong><i class="fa fa-code"></i></strong></span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary btn-block btn-lg"><i class="fa fa-send"></i> Create Machine</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
